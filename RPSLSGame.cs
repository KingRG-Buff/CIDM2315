    ...
    class RockPaperScissorsLizardSpock{
        static void Main(string[] args){
            ...
            while (human.GetPoints() > 0 && rounds < 3){
                ...
                Console.Write("--> Play again? Input Y or N to exit. "); //I was having issues with Console.WriteLine, this is Google correction result
        ...
        // I was struggling with this result, I used Google how to DetermineWinner, digging this is the result for determineWinner, switch, Case,InvalidOperationException
